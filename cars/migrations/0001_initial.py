# Generated by Django 3.1.7 on 2021-03-31 04:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('FL', 'Florida'), ('HI', 'Hawaii'), ('IA', 'Iowa'), ('ND', 'North Dakota'), ('CA', 'California'), ('MI', 'Michigan'), ('IN', 'Indiana'), ('KY', 'Kentucky'), ('ID', 'Idaho'), ('MT', 'Montana'), ('MS', 'Mississippi'), ('NY', 'New York'), ('NC', 'North Carolina'), ('CO', 'Colorado'), ('SC', 'South Carolina'), ('NJ', 'New Jersey'), ('VT', 'Vermont'), ('NH', 'New Hampshire'), ('UT', 'Utah'), ('VA', 'Virginia'), ('AR', 'Arkansas'), ('CT', 'Connecticut'), ('LA', 'Louisiana'), ('NE', 'Nebraska'), ('OK', 'Oklahoma'), ('MA', 'Massachusetts'), ('DC', 'District Of Columbia'), ('MN', 'Minnesota'), ('MD', 'Maryland'), ('PA', 'Pennsylvania'), ('NV', 'Nevada'), ('OH', 'Ohio'), ('OR', 'Oregon'), ('DE', 'Delaware'), ('TN', 'Tennessee'), ('GA', 'Georgia'), ('WA', 'Washington'), ('TX', 'Texas'), ('NM', 'New Mexico'), ('SD', 'South Dakota'), ('RI', 'Rhode Island'), ('WI', 'Wisconsin'), ('AK', 'Alaska'), ('AL', 'Alabama'), ('AZ', 'Arizona'), ('KS', 'Kansas'), ('IL', 'Illinois'), ('WV', 'West Virginia'), ('ME', 'Maine'), ('WY', 'Wyoming'), ('MO', 'Missouri')], max_length=100)),
